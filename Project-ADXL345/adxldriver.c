...
//IOCTL Call for reading the 6 data registers and implementing standby and poweron mode.
...
{
        printk(KERN_INFO "ADXL345: Removing module");
...
MODULE_DESCRIPTION("Driver for ADXL345 connected on i2c-1");
